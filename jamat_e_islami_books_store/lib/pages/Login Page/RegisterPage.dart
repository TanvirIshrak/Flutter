...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      if (mounted) {
        // Firebase keeps the new user signed in. The _AuthGate in main.dart
        // listens to authStateChanges and will swap RegisterScreen for
        // Homepage automatically — we just pop this route and confirm
        // success to the user.
